...
Dmatrix <- get_gower_dist("examples/DataMatrix.nex", numeric = FALSE)
...
3.3. Exports clusters/partitions to Nexus file with `cluster_to_nexus`.
...
4.3. Exports clusters/partitions to Nexus file with `cluster_to_nexus`. This can be copied and pasted into the [Mr. Bayes](https://nbisweden.github.io/MrBayes/) command block.
