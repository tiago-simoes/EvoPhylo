...
## (reshaping is done automatically when using the import_log function)
...
Summer statistics for each FBD parameter by time bin can be quickly summarized using `FBD_summary`:
