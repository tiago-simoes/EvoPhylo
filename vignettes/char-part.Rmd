...
## Write partitioned alignments to separate Nexus files
write_partitioned_alignments(characters, clusters, file = "alignment.nex")
```
...
4.3. Export clusters/partitions to Nexus file with `cluster_to_nexus()`. This can be copied and pasted into the [Mr. Bayes](https://nbisweden.github.io/MrBayes/) command block. Alternatively, write the partitioned alignments as separate Nexus files using `write_partitioned_alignments()`. This will allow you to import the partitions separately into BEAUti.
