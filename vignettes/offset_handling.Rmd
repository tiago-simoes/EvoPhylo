...
```{r}
## Find the example trees and log files from the package
...
converted.trees = offset.to.dummy.metadata(trees_file, log_file, output.file = "transformed_offset.trees")
```
...
mcc.file = system.file("extdata", "ex_offset.MCC.tre", package = "EvoPhylo")
## Then remove the dummy tip
mcc.tree = drop.dummy(mcc.file)
...
mcc.tree = drop.dummy(mcc.file, output.file = "final_mcc.tre")
```
