...
A package to perform automated morphological character partitioning for phylogenetic analyses and analyze macroevolutionary parameter outputs from clock (time-calibrated) Bayesian inference analyses. `EvoPhylo` was initially released for pre- and postprocess data using the software [Mr. Bayes](https://nbisweden.github.io/MrBayes/). Current developments (since v. 0.2.0) are implementing functions to also postprocess output data produced by the software package [BEAST2](http://www.beast2.org/).
